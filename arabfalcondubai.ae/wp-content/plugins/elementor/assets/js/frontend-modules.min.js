    ...
    [941], {
            ...
            var n = r(4762),
                ...
                b = e.exports = function(e, t, r) {
                    "Symbol(" === f(h(t), 0, 7) && (t = "[" + m(h(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), r && r.getter && (t = "get " + t), r && r.setter && (t = "set " + t), (!o(e, "name") || c && e.name !== t) && (a ? g(e, "name", {
                        value: t,
                        configurable: !0
                    }) : e.name = t), y && r && o(r, "arity") && e.length !== r.arity && g(e, "length", {
                        value: r.arity
                    });
                    try {
        ...
        1506: (e, t, r) => {
            ...
            e.exports = function(e, t, r) {
                var f, m, v, y, _, b, w, S = r && r.that,
                    ...
                    callFn = function(e) {
                        return E ? (s(e), C ? x(e[0], e[1], stop) : x(e[0], e[1])) : C ? x(e, stop) : x(e)
                    };
                if (k) f = e.iterator;
                else if (T) f = e;
                else {
        ...
        3827: (e, t, r) => {
            ...
            var i = n(r(6336)),
                ...
                l = n(r(8285));
            const u = 18e5,
                d = "elementor_wpdash_session",
                p = "elementor_wpdash_pending_nav",
                h = (t.CONTROL_TYPES = {
                    BUTTON: "button",
                    CHECKBOX: "checkbox",
                    RADIO: "radio",
            ...
            class WpDashboardTracking {
                ...
                static startSessionMonitoring() {
                    this.activityCheckInterval = setInterval(() => {
                        ...
                        if (!this.sessionEnded && document.hidden) {
                            Date.now() - this.lastActivityTime > u && this.trackSessionEnd("tab_inactive")
                        }
                    })
                }
                ...
                static checkSessionTimeout() {
                    Date.now() - this.lastActivityTime > u && !this.sessionEnded && this.trackSessionEnd("timeout")
                }
                ...
                static trackNavClicked(e, t = null, r = h.LEFT_MENU) {
                    if (!this.initialized) {
                        const n = {
                            itemId: e,
                            rootItem: t,
                        ...
                        return void sessionStorage.setItem(p, JSON.stringify(n))
                    }
                ...
                static trackScreenViewed(e, t = g.TAB) {
                    this.updateActivity();
                    const r = {
                        wpdash_screen_id: e,
                ...
                static destroy() {
                    ...
                    }), this.navigationListeners = [], c.default.destroy(), a.default.destroy(), o.default.destroy(), l.default.destroy(), this.initialized = !1
                }
            }
            t.default = WpDashboardTracking, window.addEventListener("elementor/admin/init", () => {
                ...
                t && s.default.init(), i.default.init(), r && (WpDashboardTracking.init(), c.default.init(), a.default.init(), o.default.init(), l.default.init())
        ...
        4077: (e, t, r) => {
            ...
            var i = n(r(3827)),
                s = n(r(6349));
            const o = ".e-feature-promotion, .elementor-settings-form-page",
